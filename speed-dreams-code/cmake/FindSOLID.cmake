...
IF(WIN32)
  ...
  FIND_LIBRARY(SOLID_MOTO_LIBRARY
    NAMES moto
    HINTS ENV SOLID_DIR
    PATH_SUFFIXES lib64 lib libs64 libs libs/Win32 libs/Win64
    PATHS /usr /usr/local)
...
IF(SOLID_FOUND)
  ...
  IF(WIN32)
    ...
    IF(SOLID_MOTO_LIBRARY)
      SET(SOLID_LIBRARY ${SOLID_LIBRARY} ${SOLID_MOTO_LIBRARY})
    ENDIF(SOLID_MOTO_LIBRARY)
  ENDIF(WIN32)
  IF(NOT TARGET solid)
    ADD_LIBRARY(solid INTERFACE IMPORTED)
    SET_TARGET_PROPERTIES(solid PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${SOLID_INCLUDE_DIR}"
      INTERFACE_LINK_LIBRARIES "${SOLID_LIBRARY}")
  ENDIF(NOT TARGET solid)
ELSE(SOLID_FOUND)
  MESSAGE(STATUS "Looking for SOLID - NOT found")
ENDIF(SOLID_FOUND)
