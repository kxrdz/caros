...
private:
    ...
    //! Executed when pre-race configuration has been applied.
    static void onCfgApply(void *args);
...
private:
    ...
    //! Hook executed when pre-race configuration has been applied.
    void *_applyHook;

    std::vector<tCarElt *> _humans;
